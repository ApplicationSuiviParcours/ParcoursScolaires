    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0 animate__animated animate__fadeInDown">
            ...
            <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                @if($classeId)
                    <a href="{{ route('admin.emploi_du_temps.exportPdf', ['classe_id' => $classeId, 'annee_scolaire_id' => $anneeScolaireId]) }}"
                    ...
                    <a href="{{ route('admin.emploi_du_temps.imprimer', ['classe_id' => $classeId, 'annee_scolaire_id' => $anneeScolaireId]) }}" target="_blank"
