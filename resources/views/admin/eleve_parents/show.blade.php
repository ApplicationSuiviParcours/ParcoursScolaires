...
@section('header')
    ...
    <div class="relative bg-blue-900 py-4 md:py-6 overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                <div class="flex items-center space-x-3 md:space-x-4 group">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-[10px] md:text-sm mt-0.5">Détails de la relation</p>
                    </div>
                </div>
...
@section('content')
    <div class="container mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div class="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 mb-6 md:mb-8 transition-shadow duration-300 hover:shadow-xl">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center space-x-3 md:space-x-4">
                    <div class="p-2 md:p-4 bg-blue-100 rounded-xl md:rounded-2xl transition-transform duration-300 hover:rotate-6">
                        <i class="fas fa-handshake text-xl md:text-3xl text-blue-900"></i>
                    </div>
                    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
            <!-- Lien parental -->
            <div class="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border-l-4 border-blue-900 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 group">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="mt-1 md:mt-2">
                            @php
                                $lienInfo = [
                                    'Père' => ['bg-blue-600', 'fa-mars', 'text-blue-900', 'bg-blue-100'],
                                    'Mère' => ['bg-pink-600', 'fa-venus', 'text-pink-600', 'bg-pink-100'],
                                    'Tuteur' => ['bg-blue-900', 'fa-user-tie', 'text-yellow-600', 'bg-blue-100'],
            ...
            <div class="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border-l-4 border-blue-500 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 group">
                <div class="flex items-center justify-between">
                    ...
                    <div class="p-2 md:p-4 bg-blue-100 rounded-xl md:rounded-2xl transition-transform duration-300 group-hover:rotate-12">
                        <i class="fas fa-calendar-alt text-xl md:text-3xl text-blue-900"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div class="bg-white rounded-xl md:rounded-2xl shadow-lg overflow-hidden group transition-all duration-500 hover:shadow-2xl">
                <div class="bg-blue-900 px-4 py-3 transition-all duration-300 group-hover:from-indigo-700 group-hover:to-indigo-800">
                ...
                <div class="p-4 md:p-6">
                    <div class="flex items-center mb-4 md:mb-6">
                        <div class="h-14 w-14 md:h-20 md:w-20 bg-blue-900 rounded-xl md:rounded-2xl flex items-center justify-center shadow-inner transition-transform duration-300 group-hover:scale-110">
                            <span class="text-blue-900 font-bold text-lg md:text-2xl">
                        ...
                        <div class="ml-3 md:ml-4 overflow-hidden">
                            <h4 class="text-base md:text-xl font-bold text-gray-900 truncate transition-colors duration-300 group-hover:text-blue-900">{{ $eleveParent->eleve->prenom }} {{ $eleveParent->eleve->nom }}</h4>
                            <p class="text-[10px] md:text-sm text-gray-500 mt-0.5">ID: #{{ $eleveParent->eleve->id }}</p>
                        </div>
                    </div>

                    <div class="space-y-3">
                        <div class="flex items-center p-3 bg-gray-50 rounded-xl transition-all duration-200 hover:bg-blue-50 hover:shadow-sm cursor-default">
                            <div class="w-9 h-9 md:w-10 md:h-10 bg-white shadow-sm rounded-lg flex items-center justify-center transition-transform duration-300 hover:rotate-12">
                                <i class="fas fa-calendar text-blue-900 text-xs md:text-sm"></i>
                            </div>
                        ...
                        <div class="flex items-center p-3 bg-gray-50 rounded-xl transition-all duration-200 hover:bg-blue-50 hover:shadow-sm cursor-default">
                            <div class="w-9 h-9 md:w-10 md:h-10 bg-white shadow-sm rounded-lg flex items-center justify-center transition-transform duration-300 hover:rotate-12">
                                <i class="fas fa-id-card text-yellow-600 text-xs md:text-sm"></i>
                            </div>
                            <div class="ml-3 overflow-hidden">
            ...
            <!-- Carte Parent -->
            <div class="bg-white rounded-xl md:rounded-2xl shadow-lg overflow-hidden group transition-all duration-500 hover:shadow-2xl">
                <div class="bg-blue-900 px-4 py-3 transition-all duration-300 group-hover:from-green-700 group-hover:to-green-800">
                    <div class="flex items-center">
                        <div class="p-1.5 md:p-2 bg-white/20 rounded-lg backdrop-blur-sm">
                ...
                <div class="p-4 md:p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center p-3 bg-gray-50 rounded-xl transition-all duration-200 hover:bg-green-50 hover:shadow-sm cursor-default group/item">
                            ...
                            <button onclick="copyToClipboard('{{ $eleveParent->parentEleve->email }}')" class="ml-2 p-1.5 text-gray-400 hover:text-blue-900 transition-all duration-200 hover:scale-125 active:scale-95">
        ...
        <div class="bg-white rounded-xl md:rounded-2xl shadow-lg mt-6 md:mt-8 overflow-hidden transition-shadow duration-300 hover:shadow-xl">
            ...
            <div class="p-4 md:p-6">
                <div class="relative">
                    <!-- Ligne -->
                    <div class="absolute left-4 md:left-8 top-0 bottom-0 w-0.5 bg-blue-900 rounded-full"></div>
                    ...
                    <div class="relative pl-10 md:pl-20 space-y-6 md:space-y-8">
                        ...
                        <div class="relative group">
                            <div class="absolute left-0 w-8 md:w-16 flex items-center justify-center -ml-5 md:-ml-10 transition-transform duration-300 group-hover:scale-125">
                                <div class="w-3 h-3 md:w-4 md:h-4 bg-blue-900 rounded-full ring-4 ring-white shadow"></div>
                            </div>
                            <div class="bg-blue-50 rounded-lg p-3 md:p-4 border border-indigo-100 transition-all duration-300 group-hover:shadow-md group-hover:border-indigo-200">
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-1">
                                    <h4 class="text-xs md:text-sm font-semibold text-indigo-800">Création</h4>
                                    <span class="text-[10px] text-blue-900 bg-blue-100 px-2 py-0.5 rounded-full whitespace-nowrap">{{ $eleveParent->created_at->format('d/m/Y H:i') }}</span>
                                </div>
