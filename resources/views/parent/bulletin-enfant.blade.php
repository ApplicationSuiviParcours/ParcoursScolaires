        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="relative mb-6 md:mb-8 overflow-hidden group rounded-2xl md:rounded-3xl">
                ...
                <div class="relative p-4 md:p-8">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div class="flex items-center space-x-4 md:space-x-6">
                            ...
                            <div class="transition-all duration-700 transform animate-slide-in-left">
                                <h3 class="text-xl md:text-4xl font-black tracking-tight text-white drop-shadow-xl">
                                    Bulletins de {{ $eleve->prenom }} {{ $eleve->nom }}</h3>
                                <div class="flex flex-wrap items-center gap-2 mt-2 md:mt-3">
                                    <span
                                        ...
                                        {{ optional($eleve->inscriptions->first()?->classe)->nom ?? 'Classe non assignée' }}
                                    </span>
                        ...
                        <div class="flex items-center justify-start mt-4 space-x-3 lg:mt-0 lg:justify-end">
                            <div class="text-left lg:text-right">
                                <p class="text-xs md:text-sm text-purple-200">Moyenne générale</p>
                                <p class="text-xl md:text-3xl font-bold text-white">
                                    {{ number_format($stats['moyenne_globale'], 2) }}/20</p>
                            </div>
                            <div
                                class="flex items-center justify-center w-12 h-12 md:w-16 md:h-16 border bg-white/20 backdrop-blur-sm rounded-xl md:rounded-2xl border-white/30 animate-float">
            ...
            <div
                ...
                @if($bulletins->count() > 0)
                    <div
                        class="flex items-center px-3 md:px-4 py-1.5 md:py-2 space-x-1 md:space-x-2 text-xs md:text-sm text-gray-600 border bg-white/80 backdrop-blur-sm rounded-lg md:rounded-xl border-gray-200/50">
            ...
            <!-- Filtres avec design moderne - responsive -->
            <div
                class="mb-6 md:mb-8 overflow-hidden transition-all duration-500 border shadow-xl bg-white/90 backdrop-blur-xl border-white/50 rounded-xl md:rounded-2xl hover:shadow-2xl animate-fade-in-up">
                <div class="p-4 md:p-6 border-b border-gray-100/50 bg-gradient-to-r from-purple-50/80 to-indigo-50/80">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 md:px-3 py-1 text-xs text-gray-500 rounded-full bg-white/50">Recherche
                            avancée</span>
                    </div>
                </div>
                <div class="p-4 md:p-6">
                    <form method="GET" action="{{ route('parent.enfant.bulletin', $eleve->id) }}"
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center text-xs md:text-sm font-medium text-gray-700">
                                <svg class="w-3 h-3 md:w-4 md:h-4 mr-1 text-purple-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex items-end space-x-2 md:space-x-3 lg:col-span-2">
                            <a href="{{ route('parent.enfant.bulletin', $eleve->id) }}"
                                class="flex-1 px-3 md:px-6 py-2 md:py-3 font-medium text-center text-gray-600 transition-all border bg-gray-100/80 backdrop-blur-sm rounded-lg md:rounded-xl hover:bg-gray-200 hover:shadow-md border-gray-200/50 group">
                                <svg class="w-4 h-4 md:w-5 md:h-5 mx-auto transition-transform duration-500 group-hover:rotate-180"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Stats Cards avec design moderne - responsive -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 mb-6 md:mb-8">
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 transition-opacity opacity-0 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 group-hover:opacity-100">
                    </div>
                ...
                <div
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <p
                                class="mt-1 md:mt-2 text-2xl md:text-5xl font-black {{ $stats['moyenne_globale'] >= 10 ? 'text-green-600' : 'text-red-600' }} group-hover:scale-110 transition-transform origin-left">
                ...
                <div
                    class="relative p-3 md:p-6 overflow-hidden transition-all duration-500 border shadow-xl group bg-white/90 backdrop-blur-xl border-white/50 rounded-xl md:rounded-2xl hover:shadow-2xl hover:-translate-y-1">
                    <div
                        class="absolute inset-0 transition-opacity opacity-0 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 group-hover:opacity-100">
                    </div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="flex items-center text-xs md:text-sm font-medium text-gray-600">
                                <span
                                    class="w-1.5 h-1.5 md:w-2 md:h-2 mr-1 md:mr-2 bg-blue-500 rounded-full animate-pulse animation-delay-400"></span>
                                Dernier bulletin
                            </p>
                            <p
                            ...
                            @if($stats['dernier'])
                                <p class="mt-0.5 md:mt-1 text-[10px] md:text-xs text-gray-400">
            ...
            <!-- Grille des bulletins - responsive -->
            @if($bulletins->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    @foreach($bulletins as $index => $bulletin)
                        ...
                        <div class="overflow-hidden transition-all duration-500 transform border shadow-xl group bg-white/90 backdrop-blur-xl border-white/50 rounded-xl md:rounded-2xl hover:shadow-2xl hover:-translate-y-2 animate-fade-in-up"
                            ...
                            <div class="h-1 md:h-2 bg-gradient-to-r {{ $mentionGradient }}"></div>
                            ...
                            <div class="p-4 md:p-6">
                                ...
                                <!-- Moyenne avec jauge circulaire - responsive -->
                                <div
                                    class="flex items-center justify-between p-3 md:p-4 mb-3 md:mb-4 bg-gray-50/80 rounded-lg md:rounded-xl">
                                    <span class="text-xs md:text-sm font-medium text-gray-600">Moyenne</span>
                                    <div class="flex items-center">
                                        <div class="relative w-12 h-12 md:w-16 md:h-16 mr-2 md:mr-3">
                                            <svg class="w-12 h-12 md:w-16 md:h-16 transform -rotate-90">
                                                <circle cx="24" cy="24" r="20" fill="none" stroke="#e5e7eb" stroke-width="3"
                                                    stroke-dasharray="125.6" />
                                                <circle cx="24" cy="24" r="20" fill="none"
                                                    stroke="{{ $moyenne >= 10 ? '#10b981' : '#ef4444' }}" stroke-width="3"
                                                    stroke-dasharray="125.6"
                                                    stroke-dashoffset="{{ 125.6 * (1 - min($moyenne / 20, 1)) }}"
                                                    stroke-linecap="round" class="transition-all duration-1000" />
                                            </svg>
                                            <div class="absolute inset-0 flex items-center justify-center">
                                                <span
                                                    class="text-[10px] md:text-xs font-bold">{{ number_format(($moyenne / 20) * 100, 0) }}%</span>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <span
                                                class="text-xl md:text-3xl font-black {{ $moyenne >= 10 ? 'text-green-600' : 'text-red-600' }}">
                                                {{ number_format($moyenne, 2) }}
                                            </span>
                                            <span class="text-xs md:text-sm text-gray-400">/20</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Mention - responsive -->
                                <div class="flex items-center justify-between mb-3 md:mb-4">
                                    <span class="text-xs md:text-sm font-medium text-gray-600">Mention</span>
                                    <span
                                        class="px-2 md:px-3 py-1 md:py-1.5 text-[10px] md:text-xs font-bold rounded-full {{ $mentionClass }} border">
                                        {{ $mention }}
                                    </span>
                                </div>
                                ...
                                @if($bulletin->appreciation)
                                    <div
                                        ...
                                        <p class="relative z-10 text-xs md:text-sm italic text-gray-600">
                                            "{{ Str::limit($bulletin->appreciation, 60) }}"</p>
                                    </div>
                                @endif

                                <!-- Footer avec date et bouton - responsive -->
                                <div
                                    class="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-3 md:pt-4 border-t border-gray-100 gap-2 sm:gap-0">
                                    <span class="flex items-center text-[10px] md:text-xs text-gray-400">
            ...
            @else
                ...
                <div
                    ...
                    <div class="absolute inset-0 opacity-10">
                        <div class="absolute w-48 h-48 md:w-64 md:h-64 bg-purple-300 rounded-full -top-32 -right-32 blur-3xl">
                        </div>
                        <div class="absolute w-48 h-48 md:w-64 md:h-64 bg-indigo-300 rounded-full -bottom-32 -left-32 blur-3xl">
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        <div class="relative inline-block animate-float">
                            ...
                            <svg class="relative text-purple-400 w-20 h-20 md:w-28 md:h-28" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                </path>
                        ...
                        <h3 class="mt-4 md:mt-6 text-lg md:text-2xl font-semibold text-gray-700">Aucun bulletin disponible</h3>
                        ...
                        <div
                            ...
                            <span>Les bulletins sont généralement publiés en fin de trimestre</span>
                        </div>
                    </div>
                </div>
            @endif

            <!-- Pagination stylisée - responsive -->
