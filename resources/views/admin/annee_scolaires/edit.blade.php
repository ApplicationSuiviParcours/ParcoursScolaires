                ...
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="{{ route('admin.annee_scolaires.index') }}" class="inline-flex items-center text-sm font-medium text-amber-200 hover:text-white transition-colors duration-300">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.annee_scolaires.show', $anneeScolaire) }}" class="ml-1 text-sm font-medium text-amber-200 hover:text-white md:ml-2 transition-colors duration-300">
                                    {{ $anneeScolaire->nom }}
                                </a>
                            </div>
                        </li>
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-amber-500 to-orange-600 px-8 py-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white mb-1">Modifier l'année scolaire</h2>
                        <p class="text-amber-100 text-sm">Modifiez les informations de l'année scolaire</p>
                    </div>
                </div>
            </div>
                ...
                <div class="mb-8 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800">{{ $anneeScolaire->nom }}</p>
                            <p class="text-sm text-gray-600">du {{ $anneeScolaire->date_debut->format('d/m/Y') }} au {{ $anneeScolaire->date_fin->format('d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.annee_scolaires.update', $anneeScolaire) }}" method="POST" id="editForm">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="group">
                                <label for="date_debut" class="block text-sm font-semibold text-gray-700 mb-2 group-hover:text-amber-600 transition-colors duration-300">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" 
                                           ...
                                           class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all duration-300 @error('date_debut') border-red-500 @enderror"
                                           required>
                                </div>
                                @error('date_debut')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="group">
                                <label for="date_fin" class="block text-sm font-semibold text-gray-700 mb-2 group-hover:text-amber-600 transition-colors duration-300">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" 
                                           ...
                                           class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all duration-300 @error('date_fin') border-red-500 @enderror"
                                           required>
                                </div>
                                @error('date_fin')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="group">
                            ...
                            <div class="relative flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-2 text-sm text-gray-700">Active (année en cours)</span>
                                </label>
                                <label class="flex items-center cursor-pointer">
        ...
        <div class="mt-8 bg-white rounded-3xl shadow-xl overflow-hidden border-l-8 border-red-500">
            ...
            <div class="p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div class="flex-1">
                        <h4 class="text-lg font-semibold text-gray-800 mb-2">Supprimer cette année scolaire</h4>
...
@push('scripts')
<script>
    // Mise à jour du récapitulatif (optionnel mais utile)
    function updateRecap() {
        ...
        // Vous pouvez afficher un récapitulatif si vous le souhaitez
    }
