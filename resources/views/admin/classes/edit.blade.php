    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-4 md:mb-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 gap-2">
                <div class="flex items-center space-x-2 md:space-x-3">
                    ...
                    <div>
                        <h3 class="text-base md:text-lg font-semibold text-gray-800">Modification de la classe</h3>
                        <p class="text-xs md:text-sm text-gray-500 hidden sm:block">Modifiez les informations ci-dessous</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl md:rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="p-4 md:p-8">
                <form action="{{ route('admin.classes.update', $classe) }}" method="POST" class="space-y-6 md:space-y-8">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-4 w-4 md:h-5 md:w-5 text-gray-400 group-focus-within:text-amber-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <input type="text"
                                           ...
                                           class="w-full pl-9 md:pl-10 pr-4 py-2.5 md:py-3 border-2 border-gray-200 rounded-lg md:rounded-xl focus:border-amber-400 focus:ring-2 focus:ring-amber-200 transition-all text-sm @error('nom') border-red-400 bg-red-50 @enderror">
                                </div>
                                <div class="flex items-center justify-between mt-1">
                                    <p class="text-[10px] md:text-xs text-gray-500">Nom unique</p>
                                    <span class="text-[10px] md:text-xs text-gray-400" id="nomCounter">{{ strlen(old('nom', $classe->nom)) }}/50</span>
                                </div>
                                @error('nom')
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number"
                                           ...
                                           max="60"
                                           required
                                           class="w-full pl-9 md:pl-10 pr-4 py-2.5 md:py-3 border-2 border-gray-200 rounded-lg md:rounded-xl focus:border-amber-400 focus:ring-2 focus:ring-amber-200 transition-all text-sm @error('capacite') border-red-400 bg-red-50 @enderror">
                                </div>
                                <div class="flex items-center justify-between mt-1">
                                    ...
                                    @endphp
                                    <span class="text-[10px] md:text-xs font-medium px-2 py-0.5 bg-{{ $capaciteColor }}-100 text-{{ $capaciteColor }}-700 rounded-full" id="capaciteBadge">
                                        {{ $capaciteValue }}/60
                                    </span>
                                </div>
                                @error('capacite')
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="niveau" id="niveau" required
                                            class="w-full pl-9 md:pl-10 pr-8 md:pr-10 py-2.5 md:py-3 border-2 border-gray-200 rounded-lg md:rounded-xl focus:border-amber-400 focus:ring-2 focus:ring-amber-200 transition-all appearance-none bg-white text-sm @error('niveau') border-red-400 bg-red-50 @enderror">
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="serie" id="serie"
                                            class="w-full pl-9 md:pl-10 pr-8 md:pr-10 py-2.5 md:py-3 border-2 border-gray-200 rounded-lg md:rounded-xl focus:border-amber-400 focus:ring-2 focus:ring-amber-200 transition-all appearance-none bg-white text-sm @error('serie') border-red-400 bg-red-50 @enderror">
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select name="annee_scolaire_id" id="annee_scolaire_id" required
                                        class="w-full pl-9 md:pl-10 pr-8 md:pr-10 py-2.5 md:py-3 border-2 border-gray-200 rounded-lg md:rounded-xl focus:border-amber-400 focus:ring-2 focus:ring-amber-200 transition-all appearance-none bg-white text-sm @error('annee_scolaire_id') border-red-400 bg-red-50 @enderror">
            ...
            <div class="flex items-start">
                <div class="flex-shrink-0">
                    <div class="bg-amber-200 p-1.5 md:p-2 rounded-lg">
                        <svg class="w-4 h-4 md:w-5 md:h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                </div>
                <div class="ml-3 md:ml-4">
                    <h5 class="text-xs md:text-sm font-semibold text-amber-800 mb-1">Information importante</h5>
                    <p class="text-xs md:text-sm text-amber-700">
