        ...
        <div class="bg-white rounded-2xl md:rounded-3xl shadow-xl overflow-hidden">
            <div class="bg-blue-900 px-4 md:px-8 py-4 md:py-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-xl md:text-2xl font-bold text-white mb-1">Modifier l'absence</h2>
            ...
            <div class="p-4 md:p-8">
                ...
                <form action="{{ route('admin.absences.update', $absence) }}" method="POST" id="editForm">
                    ...
                    <div class="space-y-5 md:space-y-6">
                        ...
                        <!-- Date d'absence -->
                        <div class="group">
                            <label for="date_absence" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2 group-hover:text-amber-600 transition-colors duration-300">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                            <div class="group">
                                <label for="heure_debut" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2 group-hover:text-amber-600 transition-colors duration-300">
                            ...
                            <div class="group">
                                <label for="heure_fin" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2 group-hover:text-amber-600 transition-colors duration-300">
                        ...
                        <!-- Motif -->
                        <div class="group">
                            <label for="motif" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2 group-hover:text-amber-600 transition-colors duration-300">
                            ...
                            <div class="relative">
                                ...
                                <textarea name="motif" 
                                          ...
                                          class="w-full pl-12 pr-4 py-2.5 md:py-3 rounded-xl border-2 border-gray-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all duration-300 @error('motif') border-red-500 @enderror text-sm md:text-base">{{ old('motif', $absence->motif) }}</textarea>
                            </div>
                            @error('motif')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <!-- Justifiée ? -->
                        <div class="group">
                            <label class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2 group-hover:text-amber-600 transition-colors duration-300">
                                Statut
                            </label>
                        ...
                        <div class="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-xs md:text-sm">
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800">{{ $absence->created_at->format('d/m/Y H:i') }}</p>
                                </div>
                                <div>
                                    <span class="text-gray-500">Modifié le</span>
                                    <p class="font-medium text-gray-800">{{ $absence->updated_at->format('d/m/Y H:i') }}</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mt-6 md:mt-8 bg-white rounded-2xl md:rounded-3xl shadow-xl overflow-hidden border-l-4 md:border-l-8 border-red-500">
            ...
            <div class="p-4 md:p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div class="flex-1">
                        <h4 class="text-base md:text-lg font-semibold text-gray-800 mb-2">Supprimer cette absence</h4>
