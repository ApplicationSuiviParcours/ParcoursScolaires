    ...
    <div class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <!-- Card 3 -->
                <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-900 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center justify-between">
                        <div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-blue-900 rounded-xl shadow-lg overflow-hidden">
                        <div class="p-8 text-white">
                            ...
                            <div class="flex space-x-4">
                                <a href="#" class="bg-white text-blue-900 px-6 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-300">
                                    Commencer
                                </a>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button class="p-3 bg-gray-50 rounded-lg hover:bg-blue-50 hover:text-blue-900 transition-colors duration-200 text-center">
