...
<div class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 py-8 md:py-12">
    ...
    <!-- Particules flottantes (masquées sur très petits écrans pour la performance) -->
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div class="text-center md:text-left">
                <nav class="flex mb-4 justify-center md:justify-start" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="{{ route('admin.annee_scolaires.index') }}" class="inline-flex items-center text-xs sm:text-sm font-medium text-blue-200 hover:text-white transition-colors duration-300">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                <svg class="w-4 h-4 sm:w-6 sm:h-6 text-blue-300" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                                </svg>
                                <span class="ml-1 text-xs sm:text-sm font-medium text-white md:ml-2 truncate max-w-[150px] sm:max-w-none">{{ $anneeScolaire->nom }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <p class="text-blue-200 text-sm sm:text-base md:text-lg animate-fade-in-up animation-delay-200">
            ...
            <div class="mt-6 md:mt-0 flex justify-center md:justify-end space-x-3 animate-fade-in-right">
                <a href="{{ route('admin.annee_scolaires.edit', $anneeScolaire) }}" 
                   class="group relative inline-flex items-center px-3 sm:px-5 py-2 sm:py-2.5 bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl overflow-hidden">
...
<div class="container mx-auto px-4 py-6 sm:py-10 bg-gray-50">
    <!-- Badge de statut -->
    <!-- Modification : Position relative sur mobile, absolute sur desktop -->
    <div class="relative mb-4 md:mb-8">
        <div class="flex justify-center md:absolute md:-top-12 md:right-0 w-full md:w-auto">
            <div class="bg-white rounded-full shadow-xl px-4 sm:px-6 py-2 sm:py-3 flex items-center space-x-2 sm:space-x-3">
                <span class="text-xs sm:text-sm font-medium text-gray-600">Statut :</span>
                @if($anneeScolaire->active)
                    <span class="inline-flex items-center px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-green-100 text-green-700">
                ...
                @else
                    <span class="inline-flex items-center px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-gray-100 text-gray-700">
                        Inactive
                    </span>
                @endif
            </div>
                ...
                <div class="p-4 sm:p-6">
                    <div class="flex items-center mb-4 sm:mb-6">
                        ...
                        <div class="ml-3 sm:ml-4">
                            <h2 class="text-lg sm:text-xl font-bold text-gray-800">{{ $anneeScolaire->nom }}</h2>
                            <p class="text-xs sm:text-sm text-gray-600">ID: #{{ $anneeScolaire->id }}</p>
                        </div>
                    </div>
                    
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden">
                ...
                <div class="p-4 sm:p-6">
                    <div class="space-y-3 sm:space-y-4">
                        ...
                        <div class="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg sm:rounded-xl">
                            <div class="flex items-center">
                                <div class="w-8 h-8 sm:w-10 sm:h-10 bg-orange-100 rounded-lg sm:rounded-xl flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                                ...
                                <div>
                                    <p class="text-xs text-gray-500">Évaluations</p>
                                    <p class="text-base sm:text-xl font-bold text-gray-800">{{ $stats['total_evaluations'] }}</p>
                                </div>
                            </div>
                            <span class="hidden sm:inline-block text-sm text-orange-600 bg-orange-50 px-2 py-1 rounded-lg">{{ $stats['total_evaluations'] }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg sm:rounded-xl">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-xs text-gray-500">Emplois du temps</p>
                        ...
                        <div class="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg sm:rounded-xl">
                            <div class="flex items-center">
                                <div class="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 rounded-lg sm:rounded-xl flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-base sm:text-xl font-bold text-gray-800">{{ $stats['total_classes'] }}</p>
                                </div>
                            </div>
                            <span class="hidden sm:inline-block text-sm text-green-600 bg-green-50 px-2 py-1 rounded-lg">{{ $stats['total_classes'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    @if($anneeScolaire->containsDate(now()))
                        <div class="mt-3 sm:mt-4 bg-green-100 text-green-700 rounded-lg sm:rounded-xl p-2 sm:p-3 text-center text-xs sm:text-sm">
                            ✅ Nous sommes actuellement dans cette année scolaire
                        </div>
                    @else
                        <div class="mt-3 sm:mt-4 bg-gray-100 text-gray-700 rounded-lg sm:rounded-xl p-2 sm:p-3 text-center text-xs sm:text-sm">
            ...
            <div class="border-b border-gray-200" x-data="{ tab: 'inscriptions' }">
                ...
                <div class="p-3 sm:p-6">
                    ...
                    <div x-show="tab === 'inscriptions'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100">
                            ...
                            <div class="overflow-x-auto -mx-3 sm:mx-0">
                                <table class="min-w-full w-full">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th class="px-3 sm:px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Élève</th>
                                            <th class="px-3 sm:px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase hidden sm:table-cell">Classe</th>
                                            <th class="px-3 sm:px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Date</th>
                                            <th class="px-3 sm:px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Statut</th>
                                        </tr>
                                    </thead>
                                            ...
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-3 sm:px-4 py-3">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="min-w-0">
                                                            <span class="text-xs sm:text-sm block truncate">{{ $inscription->eleve->nom ?? '' }}</span>
                                                            <span class="text-xs text-gray-500 block truncate sm:hidden">{{ $inscription->classe->nom ?? 'N/A' }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-3 text-sm hidden sm:table-cell">{{ $inscription->classe->nom ?? 'N/A' }}</td>
                                                <td class="px-3 sm:px-4 py-3 text-xs sm:text-sm">{{ $inscription->date_inscription->format('d/m/Y') }}</td>
                                                <td class="px-3 sm:px-4 py-3">
                        ...
                        @else
                            <p class="text-gray-500 text-center py-8 text-sm">Aucune inscription pour cette année scolaire</p>
                        @endif
                    </div>
                    ...
                    <div x-show="tab === 'evaluations'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100">
                        @if($anneeScolaire->evaluations->count() > 0)
                            <div class="space-y-2 sm:space-y-3">
                                @foreach($anneeScolaire->evaluations as $evaluation)
                                    <div class="bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4 hover:bg-gray-100 transition-colors duration-200">
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                            <div>
                                                <h4 class="font-medium text-gray-800 text-sm sm:text-base">{{ $evaluation->nom }}</h4>
                                            ...
                                            <span class="px-2 sm:px-3 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full self-start sm:self-center">
                                                {{ $evaluation->type }}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        @else
                            <p class="text-gray-500 text-center py-8 text-sm">Aucune évaluation pour cette année scolaire</p>
                        @endif
                    </div>
                    ...
                    <div x-show="tab === 'emplois'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100">
                            ...
                            <div class="space-y-2 sm:space-y-3">
                                @foreach($anneeScolaire->emploiDuTemps as $emploi)
                                    <div class="bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4 hover:bg-gray-100 transition-colors duration-200">
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                            <div>
                                                <h4 class="font-medium text-gray-800 text-sm sm:text-base">{{ $emploi->matiere->nom ?? 'N/A' }}</h4>
                                                <p class="text-xs sm:text-sm text-gray-500">
                        ...
                        @else
                            <p class="text-gray-500 text-center py-8 text-sm">Aucun emploi du temps pour cette année scolaire</p>
                        @endif
                    </div>
                </div>
            </div>
