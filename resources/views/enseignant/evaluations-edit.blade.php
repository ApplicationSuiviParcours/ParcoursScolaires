...
@section('header')
    <h2 class="font-semibold text-sm text-gray-800 leading-tight">
        ...
        <span class="text-blue-900 ml-2">Modifier l'Évaluation</span>
    </h2>
@endsection
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="px-8 py-6 bg-blue-900">
                ...
                <p class="mt-2 text-blue-100 text-sm">Veuillez modifier les champs ci-dessous pour mettre à jour cette évaluation.</p>
            </div>
            ...
            <div class="p-8">
                <form action="{{ route('enseignant.evaluations.update', $evaluation->id) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-gray-100 pb-8">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="text" name="nom" required value="{{ old('nom', $evaluation->nom) }}"
                                   class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-blue-900 focus:bg-white transition-colors"
                        ...
                        <div>
                            ...
                            <select name="classe_id" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-blue-900 focus:bg-white transition-colors">
                        ...
                        <div>
                            ...
                            <select name="matiere_id" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-blue-900 focus:bg-white transition-colors">
                        ...
                        <div>
                            ...
                            <select name="type" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-blue-900 focus:bg-white transition-colors">
                        ...
                        <div>
                            ...
                            <select name="periode" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-blue-900 focus:bg-white transition-colors">
                        ...
                        <div>
                            ...
                            <select name="annee_scolaire_id" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-blue-900 focus:bg-white transition-colors">
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-4">
                        ...
                        <button type="submit" 
                                class="px-8 py-3 bg-blue-900 hover:bg-blue-800 text-white rounded-xl font-bold transition-all shadow-lg shadow-indigo-600/30 flex items-center">
