                ...
                <form method="GET" class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="enseignant_id" id="enseignant_id" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300" required>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="annee_scolaire_id" id="annee_scolaire_id" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300">
        ...
        @if($enseignantId)
            ...
            @else
                <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-12 text-center border border-white/20 animate__animated animate__fadeInUp">
                    ...
                    <p class="text-gray-500">Aucun cours n'a été programmé pour ce professeur dans l'année sélectionnée.</p>
                </div>
            @endif
        @else
