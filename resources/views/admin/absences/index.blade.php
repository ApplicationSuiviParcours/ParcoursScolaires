                    ...
                    @forelse($absences as $absence)
                        <tr class="hover:bg-orange-50/50 transition-colors duration-200 group">
                            ...
                            <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                                <span class="text-xs md:text-sm text-gray-900">{{ \Carbon\Carbon::parse($absence->date_absence)->format('d/m/Y') }}</span>
                            </td>
                            <td class="hidden lg:table-cell px-6 py-4 whitespace-nowrap">
                                @if($absence->heure_debut && $absence->heure_fin)
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="text-sm font-medium text-gray-700">{{ \Carbon\Carbon::parse($absence->heure_fin)->format('H:i') }}</span>
                                    </div>
