...
class AnneeScolaireSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $annees = [
            ...
            ['nom' => '2024-2025', 'date_debut' => '2024-09-01', 'date_fin' => '2025-08-31', 'active' => false],
            ['nom' => '2025-2026', 'date_debut' => '2025-09-01', 'date_fin' => '2026-08-31', 'active' => true],
        ];
        ...
        $this->command->info('✅ Exactly 10 années scolaires created (2025-2026 active)');
    }
}