                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3 flex-wrap">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 text-emerald-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                </svg>
                                <span class="ml-1 text-xs sm:text-sm font-medium text-white md:ml-2">Nouvelle réinscription</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex justify-center md:justify-end animate-fade-in-right">
                <a href="{{ route('admin.reinscriptions.index') }}"
                   class="group relative inline-flex items-center px-4 sm:px-5 py-2 sm:py-2.5
                    ...
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2 flex-shrink-0 transform group-hover:-translate-x-1 transition-transform duration-300"
...
<div class="container mx-auto px-3 sm:px-4 lg:px-6 py-8 sm:py-10 bg-gray-50">
    ...
    <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl">
        ...
        <div class="relative bg-gradient-to-r from-emerald-500 to-teal-600 px-5 sm:px-8 py-5 sm:py-6">
            <div class="flex items-start sm:items-center gap-4">
                ...
                <div class="min-w-0">
                    <h2 class="text-xl sm:text-2xl font-bold text-white mb-0.5 sm:mb-1">Formulaire de création</h2>
                    <p class="text-emerald-100 text-xs sm:text-sm">Remplissez les informations ci-dessous pour créer une nouvelle réinscription</p>
                </div>
            </div>
            {{-- Badge info — caché sur xs, visible sur sm+ --}}
            <div class="hidden sm:block absolute top-3 right-4">
                <span class="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-white/20 backdrop-blur-lg text-white text-xs sm:text-sm font-medium rounded-xl">
            ...
            <p class="sm:hidden mt-3 text-xs text-emerald-200">* Champs obligatoires</p>
        </div>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <form action="{{ route('admin.reinscriptions.store') }}" method="POST" id="createForm">
                ...
                {{-- ── GRILLE PRINCIPALE : 1 col mobile → 2 col lg ── --}}
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select name="eleve_id" id="eleve_id" required
                                        class="w-full pl-10 sm:pl-12 pr-10 sm:pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-200
                                               focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200
                                               transition-all duration-300 @error('eleve_id') border-red-500 @enderror
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select name="annee_scolaire_id" id="annee_scolaire_id" required
                                        class="w-full pl-10 sm:pl-12 pr-10 sm:pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-200
                                               focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200
                                               transition-all duration-300 @error('annee_scolaire_id') border-red-500 @enderror
                                               appearance-none bg-white text-sm">
                    ...
                    <div class="space-y-5 sm:space-y-6">
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="date"
                                       name="date_reinscription" id="date_reinscription"
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 sm:p-5 border border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div id="statusPreview" class="status-badge">
                                    <span class="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-yellow-100 text-yellow-700 text-xs sm:text-sm font-medium rounded-lg">
                                        En attente
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="observation" id="observation" rows="4"
                                  ...
                                  class="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-200
                                         ...
                                         text-sm resize-y">{{ old('observation') }}</textarea>
                    </div>
                ...
                <div class="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t-2 border-gray-100">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-xs sm:text-sm font-medium text-gray-600">Complétion du formulaire</span>
                ...
                {{-- ── BOUTONS D'ACTION ─────────────────────────────────────
                     Empilés sur mobile, côte à côte sur sm+
                ──────────────────────────────────────────────────────────── --}}
                <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 sm:gap-4 mt-6 sm:mt-8 pt-5 sm:pt-6 border-t-2 border-gray-100">
                    <button type="reset"
                        ...
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 flex-shrink-0 group-hover:rotate-180 transition-transform duration-500"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-6 sm:mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-blue-100">
        <div class="flex items-start gap-3 sm:gap-4">
            ...
            <div>
                <h3 class="text-base sm:text-lg font-semibold text-blue-800 mb-1 sm:mb-2">Information importante</h3>
...
<script>
    ...
    function updateCompletion() {
        const required = document.querySelectorAll('#createForm [required]');
        let filled = 0;
    ...
    document.querySelectorAll('[required]').forEach(f => {
        f.addEventListener('change', updateCompletion);
        f.addEventListener('keyup',  updateCompletion);
    });
    ...
    document.querySelectorAll('input, select, textarea').forEach(el => {
        ...
        el.addEventListener('keyup',  () => { if (['TEXTAREA','INPUT'].includes(el.tagName)) formModified = true; });
    });
    ...
    document.querySelectorAll('.group, .bg-gradient-to-r').forEach(el => observer.observe(el));
</script>
@endpush