 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereDate(string $column, $value, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder|User whereMonth(string $column, $value, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder|User whereYear(string $column, $value, string $boolean = 'and')
 ...
 * @method static \App\Models\User firstOrFail($columns = ['*'])
 ...
 * @method int count()
 * @method static \Illuminate\Database\Eloquent\Builder|User whereNull($column, $boolean = 'and', $not = false)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereNotNull($column, $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder|User has($relation, $operator = '>=', $count = 1, $boolean = 'and', \Closure $callback = null)
 * @method bool exists()
 * 
