        ...
        <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                <form action="{{ route('admin.parents.store') }}" method="POST" enctype="multipart/form-data" id="createForm">
                    ...
                    {{-- Aperçu rapide --}}
                    <div class="mb-6 sm:mb-8 p-4 bg-blue-900 rounded-xl sm:rounded-2xl border border-emerald-200 hidden" id="previewSection">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 sm:gap-4 pt-5 sm:pt-6 border-t-2 border-gray-100">
                        ...
                        <button type="submit"
                                class="inline-flex items-center justify-center px-6 sm:px-8 py-3 bg-blue-900 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl text-sm">
