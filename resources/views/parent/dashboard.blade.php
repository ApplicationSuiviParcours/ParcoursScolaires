        ...
        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="p-6 transition-all duration-500 bg-white border border-gray-100 shadow-xl rounded-2xl hover:shadow-2xl hover:-translate-y-2">
                <div class="flex items-center justify-between">
                    ...
                    <div class="p-4 shadow-lg bg-blue-900 rounded-xl animate-float">
            ...
            <div class="p-6 transition-all duration-500 bg-white border border-gray-100 shadow-xl rounded-2xl hover:shadow-2xl hover:-translate-y-2">
                <div class="flex items-center justify-between">
                    ...
                    <div class="p-4 shadow-lg bg-blue-900 rounded-xl animate-float animation-delay-200">
                        <svg class="w-8 h-8 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-6 transition-all duration-500 bg-white border border-gray-100 shadow-xl rounded-2xl hover:shadow-2xl hover:-translate-y-2">
                <div class="flex items-center justify-between">
                    ...
                    <div class="p-4 shadow-lg bg-blue-900 rounded-xl animate-float animation-delay-400">
                        <svg class="w-8 h-8 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                        </svg>
                    </div>
            ...
            <div class="p-6 transition-all duration-500 bg-white border border-gray-100 shadow-xl rounded-2xl hover:shadow-2xl hover:-translate-y-2">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="flex items-center text-sm font-medium text-gray-500">
                            <span class="w-2 h-2 mr-2 bg-blue-800 rounded-full animate-pulse animation-delay-600"></span>
                            Bulletins
                        </p>
                        <p class="mt-2 text-4xl font-bold text-gray-900 animate-count">
                    ...
                    <div class="p-4 shadow-lg bg-blue-900 rounded-xl animate-float animation-delay-600">
                        <svg class="w-8 h-8 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 p-3 mb-4 bg-gray-50 rounded-xl">
                        ...
                        <div class="text-center p-2">
                            ...
                            <p class="text-sm font-bold text-yellow-600 mt-1 truncate">
                    ...
                    <div class="flex justify-end mt-4 space-x-2">
                        ...
                        <a href="{{ route('parent.enfant.bulletin', $enfant->id) }}" class="p-2 text-yellow-600 transition-colors bg-blue-100 rounded-lg hover:bg-purple-200" title="Voir les bulletins">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                        </a>
                        <a href="{{ route('parent.enfant.emploi-du-temps', $enfant->id) }}" class="p-2 text-blue-900 transition-colors bg-blue-100 rounded-lg hover:bg-blue-200" title="Voir l'emploi du temps">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
