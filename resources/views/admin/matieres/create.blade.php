            ...
            <div class="p-4 md:p-8">
                <form action="{{ route('admin.matieres.store') }}" method="POST" id="createForm">
                    ...
                    <div class="space-y-5 md:space-y-6">
                        ...
                        <!-- Aperçu -->
                        <div class="mt-6 md:mt-8 p-4 bg-blue-900 rounded-xl md:rounded-2xl border border-emerald-200">
                            ...
                            <div class="flex flex-col sm:flex-row items-center text-center sm:text-left space-y-3 sm:space-y-0 sm:space-x-4">
                                <div class="flex-shrink-0 w-14 h-14 md:w-16 md:h-16 bg-blue-900 rounded-xl flex items-center justify-center text-white font-bold text-xl md:text-2xl shadow-lg" id="previewInitiales">
                                    ?
                                </div>
