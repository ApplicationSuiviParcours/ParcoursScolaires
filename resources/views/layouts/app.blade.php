...
<button type="submit" onclick="return confirm('Êtes-vous sûr de vouloir vous déconnecter ?')" class="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors group">
            ...
            <div class="p-2 sm:p-3 md:p-4 lg:p-6 xl:p-8 overflow-x-hidden">
                <!-- Messages Flash -->
                @if (session('success'))
                    <div class="mb-4 p-4 rounded-lg bg-green-100 border-l-4 border-green-500 text-green-700 shadow-sm flex items-center justify-between" x-data="{ show: true }" x-show="show" x-transition.duration.500ms>
                ...
                @if (session('error'))
                    <div class="mb-4 p-4 rounded-lg bg-red-100 border-l-4 border-red-500 text-red-700 shadow-sm flex items-center justify-between" x-data="{ show: true }" x-show="show" x-transition.duration.500ms>
                        <div class="flex items-center">
                ...
                @if ($errors->any())
                    <div class="mb-4 p-4 rounded-lg bg-red-50 border-l-4 border-red-500 text-red-700 shadow-sm" x-data="{ show: true }" x-show="show" x-transition.duration.500ms>
