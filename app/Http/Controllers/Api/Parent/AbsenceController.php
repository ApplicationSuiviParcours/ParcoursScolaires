...
class AbsenceController extends Controller
{
    ...
    public function index(Request $request, $eleve_id): \Illuminate\Http\Resources\Json\AnonymousResourceCollection
    {
        ...
        $query = Absence::where('eleve_id', $eleve_id)
            ->with(['matiere']);
        ...
        $stats = [
            'total' => Absence::where('eleve_id', $eleve_id)->count(),
            'justifiees' => Absence::where('eleve_id', $eleve_id)->where('justifiee', true)->count(),
            'non_justifiees' => Absence::where('eleve_id', $eleve_id)->where('justifiee', false)->count(),
        ];
