    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 relative">
            ...
            <div class="relative flex justify-center">
                <span class="px-4 bg-transparent backdrop-blur-sm text-2xl font-black text-transparent bg-clip-text bg-blue-900">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 overflow-hidden">
            ...
            <div class="px-8 py-8 border-b border-gray-100 bg-blue-900 text-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center space-x-5">
                    <div class="w-16 h-16 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center p-1 border border-white/30 shadow-inner">
                        ...
                        @else
                            <div class="h-14 w-14 rounded-full bg-blue-100 flex items-center justify-center text-indigo-500 font-bold text-xl">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-sm font-medium mt-1 opacity-90"><svg class="inline w-4 h-4 mr-1 pb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>{{ $user->email }}</p>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('profile.update') }}" class="p-8 sm:p-10 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2 relative group">
                        ...
                        <input type="text"
                               ...
                               class="w-full px-5 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-blue-900 focus:bg-white transition-all shadow-sm group-hover:border-indigo-200"
                               required>
                    </div>
                    ...
                    <div class="space-y-2 relative group">
                        <label for="email" class="text-sm font-bold text-gray-700 tracking-wide flex items-center">
                            <span class="bg-blue-100 text-yellow-600 rounded-full p-1.5 mr-2 group-hover:scale-110 transition-transform"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg></span>
                        ...
                        <input type="email"
                               ...
                               class="w-full px-5 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-blue-900 focus:bg-white transition-all shadow-sm group-hover:border-purple-200"
                               required>
                        ...
                        @if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !$user->hasVerifiedEmail())
                            <div class="absolute -bottom-6 left-0 text-xs text-amber-600 flex items-center font-medium">
                                ...
                                <a href="{{ route('verification.notice') }}" class="ml-1 text-yellow-600 hover:text-purple-800 underline font-bold transition-colors">Renvoyer le lien</a>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="mt-10 pt-8 border-t border-gray-100 flex flex-col-reverse sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        ...
                        <button type="submit" class="w-full justify-center sm:w-auto inline-flex items-center px-8 py-3 bg-blue-900 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-[1.02] transform transition-all focus:ring-4 focus:ring-indigo-200">
                            Sauvegarder
                        </button>
                    </div>
                </div>
