                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3 flex-wrap">
                        <li class="inline-flex items-center">
                            <a href="{{ route('admin.matieres.index') }}" class="inline-flex items-center text-sm font-medium text-blue-200 hover:text-white transition-colors duration-300">
                                ...
                                <span class="hidden sm:inline">Matieres</span>
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-white md:ml-2 truncate max-w-[150px] md:max-w-none">{{ $matiere->nom }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex flex-col sm:flex-row justify-center md:justify-end space-y-3 sm:space-y-0 sm:space-x-3 animate-fade-in-right">
                <a href="{{ route('admin.matieres.edit', $matiere) }}" 
                   class="group relative inline-flex items-center justify-center px-4 py-2.5 md:px-5 bg-yellow-500 hover:bg-yellow-600 text-white font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl overflow-hidden text-sm">
                    ...
                    <svg class="w-4 h-4 md:w-5 md:h-5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.matieres.index') }}" 
                   class="group relative inline-flex items-center justify-center px-4 py-2.5 md:px-5 bg-white/10 backdrop-blur-lg hover:bg-white/20 text-white font-medium rounded-xl transition-all duration-300 transform hover:scale-105 border border-white/20 text-sm">
                    <svg class="w-4 h-4 md:w-5 md:h-5 sm:mr-2 transform group-hover:-translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="container mx-auto px-4 py-6 md:py-10 bg-gray-50">
    <!-- Badge d'identité flottant (Masqué sur mobile pour éviter les chevauchements) -->
            ...
            <div class="p-4 md:p-6">
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    <div class="bg-gray-50 rounded-xl p-3 text-center">
                        ...
                        <p class="font-medium text-gray-800 text-sm">{{ $matiere->created_at->format('d/m/Y') }}</p>
                    </div>
                    <div class="bg-gray-50 rounded-xl p-3 text-center">
                        <p class="text-xs text-gray-500">Modifié le</p>
                        <p class="font-medium text-gray-800 text-sm">{{ $matiere->updated_at->format('d/m/Y') }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="space-y-3 md:space-y-4">
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                        <div class="flex items-center min-w-0">
                            ...
                            <div>
                                <p class="text-xs md:text-sm text-gray-500">Évaluations</p>
                                <p class="text-lg md:text-xl font-bold text-gray-800">{{ $stats['total_evaluations'] }}</p>
                            </div>
                        </div>
                        <span class="text-xs text-green-600 bg-green-100 px-2 py-1 rounded-lg hidden sm:block">+{{ $stats['total_evaluations'] }}</span>
                    </div>

                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                        <div class="flex items-center min-w-0">
                            <div class="w-10 h-10 bg-orange-100 rounded-xl flex items-center justify-center mr-3 flex-shrink-0">
                                <svg class="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                            </div>
                            <div>
                                <p class="text-xs md:text-sm text-gray-500">Absences</p>
                                <p class="text-lg md:text-xl font-bold text-gray-800">{{ $stats['total_absences'] }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                        <div class="flex items-center min-w-0">
                            ...
                            <div>
                                <p class="text-xs md:text-sm text-gray-500">Classes</p>
                                <p class="text-lg md:text-xl font-bold text-gray-800">{{ $stats['total_classes'] }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                        <div class="flex items-center min-w-0">
                            ...
                            <div>
                                <p class="text-xs md:text-sm text-gray-500">Enseignants</p>
                                <p class="text-lg md:text-xl font-bold text-gray-800">{{ $stats['total_enseignants'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4 md:space-y-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-xs md:text-sm font-medium text-gray-600">Moyenne générale</span>
                            <span class="text-base md:text-lg font-bold {{ $stats['moyenne_notes'] >= 10 ? 'text-green-600' : 'text-red-600' }}">
                    ...
                    <div class="grid grid-cols-2 gap-3 md:gap-4">
                        <div class="bg-red-50 rounded-xl p-3 md:p-4 text-center">
                            <p class="text-xs text-red-600 mb-1">Note minimum</p>
                            <p class="text-xl md:text-2xl font-bold text-red-700">{{ $stats['note_min'] }}</p>
                        ...
                        <div class="bg-green-50 rounded-xl p-3 md:p-4 text-center">
                            ...
                            <p class="text-xl md:text-2xl font-bold text-green-700">{{ $stats['note_max'] }}</p>
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-xs md:text-sm text-gray-500">Heures de cours</p>
                                <p class="text-lg md:text-xl font-bold text-gray-800">{{ $stats['total_heures_cours'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="border-b border-gray-200" x-data="{ tab: 'classes' }">
            ...
            <div class="p-4 md:p-6">
                ...
                <div x-show="tab === 'classes'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100">
                    ...
                    @else
                        <p class="text-gray-500 text-center py-8 text-sm">Aucune classe associée</p>
                    @endif
                </div>
                ...
                <div x-show="tab === 'enseignants'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100">
                                ...
                                <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl md:rounded-2xl p-4 md:p-5 hover:shadow-lg transition-all duration-300">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3 md:ml-4 flex-1 min-w-0">
                                            <h4 class="font-bold text-gray-800 text-sm md:text-base truncate">{{ $enseignant->prenom }} {{ $enseignant->nom }}</h4>
                                            <p class="text-xs text-gray-500 truncate">{{ $enseignant->specialite ?? 'Enseignant' }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    @else
                        <p class="text-gray-500 text-center py-8 text-sm">Aucun enseignant associé</p>
                    @endif
                </div>
                ...
                <div x-show="tab === 'evaluations'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100">
                    @if($matiere->evaluations->count() > 0)
                        <div class="space-y-3">
                            @foreach($matiere->evaluations as $evaluation)
                                <div class="bg-gray-50 rounded-xl p-3 md:p-4 hover:bg-gray-100 transition-colors duration-200">
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                        <div class="min-w-0">
                                            <h4 class="font-medium text-gray-800 text-sm md:text-base truncate">{{ $evaluation->titre }}</h4>
                                        ...
                                        <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full self-start sm:self-center flex-shrink-0">
                                            {{ $evaluation->type }}
                                        </span>
                                    </div>
                                </div>
                    ...
                    @else
                        <p class="text-gray-500 text-center py-8 text-sm">Aucune évaluation</p>
                    @endif
                </div>
                ...
                <div x-show="tab === 'absences'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100">
                        ...
                        <div class="space-y-3">
                            @foreach($matiere->absences as $absence)
                                <div class="bg-gray-50 rounded-xl p-3 md:p-4 hover:bg-gray-100 transition-colors duration-200">
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                        <div class="min-w-0">
                                            <h4 class="font-medium text-gray-800 text-sm md:text-base truncate">{{ $absence->eleve->prenom ?? '' }} {{ $absence->eleve->nom ?? '' }}</h4>
                                            <p class="text-xs md:text-sm text-gray-500">
                                                {{ $absence->classe->nom ?? 'N/A' }} • 
                                                {{ $absence->date_absence->format('d/m/Y') }}
                                            </p>
                                        </div>
                                        <span class="px-3 py-1 {{ $absence->justifiee ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }} text-xs font-medium rounded-full self-start sm:self-center flex-shrink-0">
                    ...
                    @else
                        <p class="text-gray-500 text-center py-8 text-sm">Aucune absence</p>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="flex justify-center md:justify-end">
        <button onclick="window.print()" 
                class="w-full sm:w-auto px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center justify-center text-sm">
...
@push('styles')
<style>
    /* Cache la barre de scroll horizontale pour les onglets sur webkit */
