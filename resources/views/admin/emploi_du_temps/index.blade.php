...
<div class="min-h-screen bg-transparent py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0 animate__animated animate__fadeInDown">
            ...
            <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                ...
                <a href="{{ route('admin.emploi_du_temps.create') }}"
                   class="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-yellow-500 text-blue-900 font-bold text-white font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-sm">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div class="flex items-end sm:col-span-2 lg:col-span-1">
                            <div class="flex flex-wrap gap-2 w-full">
                                <button type="submit"
                                        class="flex-1 sm:flex-none inline-flex items-center justify-center px-5 py-2.5 bg-blue-900 text-white font-medium rounded-xl hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 text-sm">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden border border-white/20 animate__animated animate__fadeInUp">
            <div class="bg-blue-900/80 px-4 sm:px-6 py-4 border-b border-gray-200">
                            ...
                            <tr class="hover:bg-white/60 transition-colors group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($emploi->enseignant)
                                        <div class="flex items-center">
                                            <div class="w-8 h-8 bg-blue-900 rounded-full flex items-center justify-center text-white text-xs font-bold mr-2 flex-shrink-0">
                                ...
                                <td class="px-3 md:px-4 py-3 whitespace-nowrap">
                                    <div class="flex items-center justify-end gap-1 md:gap-2 whitespace-nowrap">
                                        <a href="{{ route('admin.emploi_du_temps.show', $emploi) }}" class="p-1.5 md:p-2 text-blue-900 bg-transparent hover:bg-blue-50 rounded-lg transition-colors border-none flex-shrink-0" title="Voir">
                            ...
                            <div>
                                ...
                                @if($emploi->enseignant)
                                    <div class="flex items-center space-x-2">
                                        <div class="w-6 h-6 flex-shrink-0 bg-blue-900 rounded-full flex items-center justify-center text-white text-xs font-bold">
                                            {{ substr($emploi->enseignant->nom, 0, 1) }}{{ substr($emploi->enseignant->prenom, 0, 1) }}
                                        </div>
