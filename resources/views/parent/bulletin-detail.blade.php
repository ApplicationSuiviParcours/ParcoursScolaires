...
@section('content')
    ...
    <div class="py-6 md:py-12">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="relative p-4 md:p-8">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div class="flex items-center space-x-4 md:space-x-6">
                            <!-- Avatar élève avec effet 3D - responsive -->
                            <div class="relative group perspective">
                                <div
                                    ...
                                    <div
                                        class="flex items-center justify-center w-16 h-16 md:w-24 md:h-24 transition-all duration-300 border-4 shadow-2xl bg-white/20 backdrop-blur-xl rounded-xl md:rounded-2xl border-white/50 group-hover:scale-110 group-hover:shadow-purple-500/50">
                                        <span class="text-2xl md:text-4xl font-bold text-white drop-shadow-lg">
                                            {{ substr($eleve->prenom, 0, 1) }}{{ substr($eleve->nom, 0, 1) }}
                                        </span>
                                    </div>
                                </div>
                                <div
                                    class="absolute w-3 h-3 md:w-5 md:h-5 bg-green-400 border-2 md:border-4 border-white rounded-full -bottom-1 -right-1 animate-pulse ring-2 ring-purple-500/50">
                                </div>
                            </div>

                            <div class="transition-all duration-700 transform animate-slide-in-left">
                                <h3 class="text-lg md:text-4xl font-black tracking-tight text-white drop-shadow-xl">Bulletin
                                    scolaire</h3>
                                <div class="flex flex-wrap items-center gap-2 mt-2 md:mt-3">
                                    <span
                                        class="inline-flex items-center px-2 md:px-4 py-1 md:py-2 text-xs md:text-sm font-medium text-white transition-all border rounded-full bg-white/20 backdrop-blur-sm border-white/30 hover:bg-white/30">
                        ...
                        <div class="mt-4 text-center lg:mt-0 lg:text-right">
                            <p class="text-xs md:text-sm font-medium tracking-wider text-purple-200 uppercase">Moyenne
                                générale</p>
                            <div class="flex items-center justify-center lg:justify-end">
                                <span
                                    class="text-3xl md:text-6xl font-black text-white drop-shadow-2xl">{{ number_format($moyenneGenerale, 2) }}</span>
                                <span class="ml-1 md:ml-2 text-lg md:text-2xl font-light text-purple-200">/20</span>
                            </div>
                            <div
                                class="mt-1 md:mt-2 px-2 md:px-4 py-1 md:py-1.5 bg-white/20 backdrop-blur-sm rounded-full inline-flex items-center">
                                <span
                                    class="w-1.5 h-1.5 md:w-2 md:h-2 mr-1 md:mr-2 bg-green-400 rounded-full animate-pulse"></span>
                                <span class="text-[10px] md:text-xs text-white">Mise à jour récente</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Informations générales avec design moderne - responsive -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
                ...
                <div
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 md:mt-2 text-xl md:text-4xl font-black text-gray-900">
                                {{ $bulletin->rang ?? '-' }}</p>
                            @if($bulletin->effectif_classe)
                                <p class="mt-0.5 md:mt-1 text-[10px] md:text-xs text-gray-500">sur
                                    {{ $bulletin->effectif_classe }} élèves</p>
                            @endif
                        </div>
                        <div
                ...
                <div
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 md:mt-2 text-xl md:text-4xl font-black text-gray-900">
                                {{ number_format($moyenneClasse, 2) }}</p>
                ...
                <div
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <p
                                class="mt-1 md:mt-2 text-xl md:text-4xl font-black {{ $ecart >= 0 ? 'text-green-600' : 'text-red-600' }}">
                ...
                <div
                    class="relative p-3 md:p-6 overflow-hidden transition-all duration-500 border shadow-xl group bg-white/90 backdrop-blur-xl border-white/50 rounded-xl md:rounded-2xl hover:shadow-2xl hover:-translate-y-1">
                    <div
                        class="absolute inset-0 transition-opacity opacity-0 bg-gradient-to-r from-orange-500/10 to-red-500/10 group-hover:opacity-100">
                    </div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="flex items-center text-xs md:text-sm font-medium text-gray-600">
                                <span
                                    class="w-1.5 h-1.5 md:w-2 md:h-2 mr-1 md:mr-2 bg-orange-500 rounded-full animate-pulse animation-delay-600"></span>
                                Total points
                            </p>
                            <p class="mt-1 md:mt-2 text-xl md:text-4xl font-black text-gray-900">
                                {{ number_format($totalPoints, 2) }}</p>
                            <p class="mt-0.5 md:mt-1 text-[10px] md:text-xs text-gray-500">Coeff. {{ $totalCoefficients }}
                            </p>
                        </div>
                        <div
            ...
            <!-- Mention et statut avec design moderne - responsive -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 mb-6 md:mb-8">
                <div
                    class="relative p-3 md:p-6 overflow-hidden transition-all duration-500 border shadow-xl group bg-white/90 backdrop-blur-xl border-white/50 rounded-xl md:rounded-2xl hover:shadow-2xl hover:-translate-y-1">
                    <div
                        class="absolute inset-0 transition-opacity opacity-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 group-hover:opacity-100">
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-xs md:text-sm font-medium text-gray-600">Mention</p>
                            <div class="flex items-center mt-1 md:mt-2">
                                <div
                                    class="w-8 h-8 md:w-12 md:h-12 bg-gradient-to-br {{ $mentionClass }} rounded-lg md:rounded-xl flex items-center justify-center shadow-lg mr-2 md:mr-4">
        ...
        ($mention == 'Bien' ? 'text-blue-600' :
            ($mention == 'Assez bien' ? 'text-yellow-600' :
                ($mention == 'Passable' ? 'text-orange-600' : 'text-red-600'))) }}">
                                    ...
                                    <p class="text-[10px] md:text-xs text-gray-500">Mention obtenue</p>
                                </div>
                            </div>
                        </div>
                        <div class="text-right">
                            <div
                                class="text-3xl md:text-6xl font-black {{ $moyenneGenerale >= 10 ? 'text-green-600' : 'text-red-600' }} opacity-20">
                                {{ number_format($moyenneGenerale, 1) }}</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-1 md:mt-2">
                                ...
                                <div>
                                    <p
                                        class="text-lg md:text-3xl font-black {{ $estAdmis ? 'text-green-600' : 'text-red-600' }}">
                                        {{ $estAdmis ? 'ADMIS' : 'NON ADMIS' }}
                                    </p>
                                    <p class="text-[10px] md:text-xs text-gray-500">Seuil d'admission : 10/20</p>
                                </div>
                            </div>
                        </div>
                        <div class="text-right">
                            <div class="relative w-12 h-12 md:w-20 md:h-20">
                                <svg class="w-12 h-12 md:w-20 md:h-20 transform -rotate-90">
                                    <circle cx="24" cy="24" r="20" fill="none" stroke="#e5e7eb" stroke-width="3"
                                        stroke-dasharray="125.6" />
                                    <circle cx="24" cy="24" r="20" fill="none"
                                        stroke="{{ $estAdmis ? '#10b981' : '#ef4444' }}" stroke-width="3"
                                        stroke-dasharray="125.6"
                                        stroke-dashoffset="{{ 125.6 * (1 - min($moyenneGenerale / 20, 1)) }}"
                                        stroke-linecap="round" class="transition-all duration-1000" />
                                </svg>
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <span
                                        class="text-[10px] md:text-sm font-bold">{{ number_format(($moyenneGenerale / 20) * 100, 0) }}%</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Appréciation générale - responsive -->
            @if($bulletin->appreciation)
                <div
                    ...
                    <div class="flex items-start space-x-2 md:space-x-4">
                        ...
                        <div class="flex-1">
                            <p class="mb-1 md:mb-2 text-[10px] md:text-sm font-semibold tracking-wider text-gray-600 uppercase">
                                Appréciation générale</p>
                            <p class="text-sm md:text-xl italic leading-relaxed text-gray-700">"{{ $bulletin->appreciation }}"
                            </p>
                            <p class="flex items-center mt-1 md:mt-2 text-[10px] md:text-xs text-gray-500">
                                <span class="w-1 h-1 mr-1 md:mr-2 bg-gray-400 rounded-full"></span>
            ...
            @if(!$hasNotes)
                <div
                    ...
                    <h4 class="mb-1 md:mb-2 text-base md:text-xl font-semibold text-gray-800">Aucune note disponible</h4>
                    <p class="text-xs md:text-sm text-gray-600">Les notes pour ce bulletin n'ont pas encore été saisies.</p>
                </div>
            @endif

            <!-- Détail des notes par matière avec design moderne - responsive -->
            @if($hasNotes)
                <div
                    class="overflow-hidden border shadow-xl bg-white/90 backdrop-blur-xl border-white/50 rounded-xl md:rounded-2xl">
                    <div class="p-4 md:p-6 border-b border-gray-100/50 bg-gradient-to-r from-purple-50/80 to-indigo-50/80">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
                            ...
                            <span
                                class="px-2 md:px-4 py-1 md:py-2 text-[10px] md:text-sm text-gray-600 border border-gray-200 rounded-full bg-white/50 backdrop-blur-sm">
                    ...
                    <div class="p-4 md:p-6">
                        <div class="overflow-x-auto">
                            <table class="min-w-full md:w-full divide-y divide-gray-200">
                                <thead>
                                    <tr>
                                        <th
                                            class="px-3 md:px-6 py-3 md:py-4 text-xs font-bold tracking-wider text-left text-gray-600 uppercase bg-gray-50/50 rounded-tl-xl whitespace-nowrap">
                                            Matière</th>
                                        <th
                                            class="px-3 md:px-6 py-3 md:py-4 text-xs font-bold tracking-wider text-left text-gray-600 uppercase bg-gray-50/50 whitespace-nowrap">
                                            Coefficient</th>
                                        <th
                                            class="px-3 md:px-6 py-3 md:py-4 text-xs font-bold tracking-wider text-left text-gray-600 uppercase bg-gray-50/50 whitespace-nowrap">
                                            Notes</th>
                                        <th
                                            ...
                                            Moyenne</th>
                                        <th
                                            class="px-3 md:px-6 py-3 md:py-4 text-xs font-bold tracking-wider text-left text-gray-600 uppercase bg-gray-50/50 rounded-tr-xl whitespace-nowrap">
                                            Appréciation</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-100">
                                    @foreach($notesParMatiere as $matiereId => $data)
                                        ...
                                        @endphp
                                        <tr
                                            class="transition-all duration-300 group hover:bg-gradient-to-r hover:from-purple-50/50 hover:to-indigo-50/50">
                                            <td class="px-3 md:px-6 py-3 md:py-5">
                                                <div class="flex items-center">
                                                    ...
                                                    <span
                                                        class="text-xs md:text-sm font-semibold text-gray-800">{{ $data['matiere_nom'] ?? 'Matière inconnue' }}</span>
                                                </div>
                                            </td>
                                            <td class="px-3 md:px-6 py-3 md:py-5">
                                                <span
                                                ...
                                                <div class="flex flex-wrap gap-1 md:gap-2">
                                                    @forelse($data['notes'] ?? [] as $note)
                                                        ...
                                                        <span class="relative group/note">
                                                            <span
                                                                class="inline-flex items-center px-2 md:px-3 py-1 md:py-1.5 text-[10px] md:text-xs font-bold {{ $bgColor }} rounded-lg border shadow-sm cursor-help">
                                                                {{ number_format($note['valeur'] ?? 0, 1) }}
                                                            </span>
                                                            <div
                                                                class="absolute z-10 px-2 md:px-3 py-1 md:py-2 mb-2 text-[10px] md:text-xs text-white transition-opacity transform -translate-x-1/2 bg-gray-900 rounded-lg opacity-0 pointer-events-none bottom-full left-1/2 group-hover/note:opacity-100 whitespace-nowrap">
                                                                {{ $note['evaluation'] ?? 'Évaluation' }}
                                                                @if(!empty($note['date']))
                                                                    <br><span
                                                                        class="text-gray-400">{{ \Carbon\Carbon::parse($note['date'])->format('d/m/Y') }}</span>
                                                                @endif
                                                            </div>
                                                        </span>
                                                    @empty
                                                        <span class="text-xs italic text-gray-400">Aucune note</span>
                                                    @endforelse
                                                </div>
                                            </td>
                                            <td class="px-3 md:px-6 py-3 md:py-5">
                                                <div class="relative inline-block">
                                                    <span
                                                        class="px-2 md:px-5 py-1.5 md:py-2.5 text-[10px] md:text-sm font-black rounded-lg md:rounded-xl bg-gradient-to-r {{ $gradientClass }} text-white shadow-lg group-hover:shadow-xl transition-all whitespace-nowrap">
                                                        {{ number_format($moyenneMatiere, 2) }}/20
                                                    </span>
                                                    <span
                                                        class="absolute w-1.5 h-1.5 md:w-3 md:h-3 bg-green-400 border-2 border-white rounded-full -top-1 -right-1 animate-pulse"></span>
                                                </div>
                                            </td>
                                            <td class="px-3 md:px-6 py-3 md:py-5 max-w-[120px] md:max-w-xs">
                                                ...
                                                @if($appreciationTrouvee != '-')
                                                    <div class="flex items-center space-x-1 md:space-x-2 group/appreciation">
                                                        <svg class="flex-shrink-0 w-3 h-3 md:w-4 md:h-4 text-purple-500"
                                    ...
                                    <tr class="font-semibold bg-gradient-to-r from-purple-50 to-indigo-50">
                                        ...
                                        <td class="px-3 md:px-6 py-3 md:py-5 text-xs md:text-sm text-gray-700">
                                        ...
                                        <td class="px-3 md:px-6 py-3 md:py-5 text-xs md:text-sm text-gray-700">
                                            Moy. <span
                                                class="font-bold {{ $moyenneGenerale >= 10 ? 'text-green-600' : 'text-red-600' }}">{{ number_format($moyenneGenerale, 2) }}</span>/20
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <!-- Appréciations des professeurs - responsive -->
            @if(count($appreciations) > 0)
                <div
                    class="mt-6 md:mt-8 overflow-hidden border shadow-xl bg-white/90 backdrop-blur-xl border-white/50 rounded-xl md:rounded-2xl">
                    <div class="p-4 md:p-6 border-b border-gray-100/50 bg-gradient-to-r from-yellow-50/80 to-amber-50/80">
                        <h4 class="flex items-center text-base md:text-xl font-semibold text-gray-900">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                            @foreach($appreciations as $appreciation)
                                <div
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="text-xs md:text-sm font-semibold text-gray-900">
                                                    {{ $appreciation->professeur->nom ?? 'Professeur' }}</p>
                                                <p class="text-[10px] md:text-xs text-gray-500">
                                                    {{ $appreciation->matiere->nom ?? 'Général' }}</p>
                                            </div>
                                        </div>
                                    ...
                                    <p class="text-xs md:text-sm italic leading-relaxed text-gray-700">
                                        "{{ $appreciation->contenu ?? '' }}"</p>
                                    <div class="flex justify-end mt-1 md:mt-2">
                                        <span class="text-[10px] md:text-xs text-gray-400">Professeur principal</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            <!-- Mini graphique de progression - responsive -->
                        ...
                        @foreach($notesParMatiere as $data)
                            ...
                            <div>
                                <div class="flex justify-between mb-0.5 md:mb-1 text-[10px] md:text-sm">
                                    ...
                                    <span
                                        class="font-bold {{ $data['moyenne'] >= 10 ? 'text-green-600' : 'text-red-600' }}">{{ number_format($data['moyenne'], 2) }}/20</span>
                                </div>
                                <div class="w-full h-2 md:h-3 overflow-hidden bg-gray-200 rounded-full">
